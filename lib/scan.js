 ...
 * by 5x - the default is an Opus-tier rate, so an unrecognised Sonnet prices
 * 67% over list - and callers surface `known: false` to say so.
 */
function ratesFor(rec, pricing) {
  ...
  const m = models[name] || pricing.default || { input: 0, output: 0 };
