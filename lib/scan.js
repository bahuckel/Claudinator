...
const TUNABLES = [
  ...
  },
  {
    ...
    help: 'What a freshly compacted session is assumed to weigh. Only feeds the savings estimate, and is always kept below the threshold.',
    def: 20000,
    min: 2000,
    max: 200000,
    step: 1000,
...
function saveConfig(patch) {
  ...
  for (const t of TUNABLES) {
    ...
    if (v === null) {
      throw Object.assign(new Error(t.key + ' must be a number'), { code: 'EBADVALUE' });
    }
    cfg[t.key] = v;
  }
